...
- Current state：Firestore Rules are live；the two application files are Preview-verified but not yet republished。Next gate is one user-operated AI Studio Republish，followed by one controlled Production persistence regression。
